...
> **Related GDDs**: [Every system that exposes information through the HUD — e.g., combat design doc, progression design doc]
> **Accessibility Tier**: Basic | Standard | Comprehensive | Exemplary
> **Style Reference**: [Link to art bible HUD section if it exists]
...
> complaints in game reviews. This section defines HUD-specific requirements.
...
|----------|-------|----------|-----------|
| [e.g., Should the minimap show enemy positions by default, or only after a detection skill is unlocked?] | [systems-designer + ui-designer] | [Sprint 5, Day 2] | [Pending — depends on progression design decision] |
