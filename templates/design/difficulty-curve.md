...
> **Last Updated**: [Date]
> **Links To**: [game concept doc]
> **Relevant GDDs**: [e.g., combat design doc, progression design doc]
...
> values live in data files. The tuning range is the safe operating range:
