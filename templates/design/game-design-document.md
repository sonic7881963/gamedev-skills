...
[Declare every explicit dependency on another design document's specific mechanic, value, or
rule. If you reference another system's behaviour anywhere in this document, it must appear here.]

| This Document References | Target Doc | Specific Element Referenced | Nature |
|--------------------------|-----------|----------------------------|--------|
| [e.g., "combo multiplier feeds score"] | `[score design doc]` | `combo_multiplier` output value | Data dependency |
| [e.g., "death triggers respawn"] | `[respawn design doc]` | Death state transition | State trigger |
| [e.g., "stamina gates dodge"] | `[stamina design doc]` | Stamina depletion rule | Rule dependency |
