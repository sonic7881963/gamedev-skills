...
> **Related GDDs**: [Links to the design doc sections that generated this UI requirement]
...
> This section documents requirements specific to this screen.
>
...
| [e.g., Do we support controller cursor (free aim) in the item grid, or d-pad-only grid navigation?] | [lead-programmer + ui-designer] | [Sprint 4, Day 3] | [Pending] |
| [e.g., What is the game's item drop policy — permanent loss or drop-to-world?] | [systems-designer] | [Requires design doc update] | [Blocked on inventory design doc Edge Cases section] |
